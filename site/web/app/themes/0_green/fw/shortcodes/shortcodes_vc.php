...
//			vc_remove_element("vc_accordion_tab");
			...
			vc_map( array(
				"base" => "trx_price",
				"name" => esc_html__("Price", "green"),
				"description" => esc_html__("Insert price with decoration", "green"),
				"category" => esc_html__('Content', 'js_composer'),
				'icon' => 'icon_trx_price',
				...
				"params" => array(
					array(
						"param_name" => "money",
						"heading" => esc_html__("Money", "green"),
						"description" => esc_html__("Money value (dot or comma separated)", "green"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						"param_name" => "currency",
						"heading" => esc_html__("Currency symbol", "green"),
						"description" => esc_html__("Currency character", "green"),
						"admin_label" => true,
						"class" => "",
						"value" => "$",
						"type" => "textfield"
					...
					array(
						"param_name" => "period",
						"heading" => esc_html__("Period", "green"),
						"description" => esc_html__("Period text (if need). For example: monthly, daily, etc.", "green"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						"param_name" => "align",
						"heading" => esc_html__("Alignment", "green"),
						"description" => esc_html__("Align price to left or right side", "green"),
						"admin_label" => true,
						"class" => "",
						"value" => array_flip($GREEN_GLOBALS['sc_params']['float']),
						"type" => "dropdown"
			...
			class WPBakeryShortCode_Trx_Price extends GREEN_VC_ShortCodeSingle {}
			...
			vc_map( array(
				...
				"name" => esc_html__("Price block", "green"),
				"description" => esc_html__("Insert price block with title, price and description", "green"),
				"category" => esc_html__('Content', 'js_composer'),
				...
				"params" => array(
					array(
						"param_name" => "title",
						"heading" => esc_html__("Title", "green"),
						"description" => esc_html__("Block title", "green"),
						"admin_label" => true,
						"class" => "",
						"value" => "",
						"type" => "textfield"
					...
					array(
						"param_name" => "link",
						"heading" => esc_html__("Link URL", "green"),
						"description" => esc_html__("URL for link from button (at bottom of the block)", "green"),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						...
						"heading" => esc_html__("Link text", "green"),
						"description" => esc_html__("Text (caption) for the link button (at bottom of the block). If empty - button not showed", "green"),
						"class" => "",
						"value" => "",
						"type" => "textfield"
					),
					array(
						"param_name" => "icon",
						"heading" => esc_html__("Icon", "green"),
						"description" => esc_html__("Select icon from Fontello icons set (placed before/instead price)", "green"),
						"class" => "",
						"value" => $GREEN_GLOBALS['sc_params']['icons'],
						"type" => "dropdown"
					),
					...
					array(
						"param_name" => "content",
						"heading" => esc_html__("Description", "green"),
						"description" => esc_html__("Description for this price block", "green"),
						"class" => "",
						"value" => "",
						"type" => "textarea_html"
					),
			...
			class WPBakeryShortCode_Trx_PriceBlock extends GREEN_VC_ShortCodeSingle {}
