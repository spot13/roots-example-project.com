...
add_shortcode('trx_accordion', 'green_sc_accordion');
...
add_shortcode('trx_accordion_item', 'green_sc_accordion_item');
...
add_shortcode("trx_anchor", "green_sc_anchor");
...
add_shortcode("trx_audio", "green_sc_audio");
...
add_shortcode('trx_blogger', 'green_sc_blogger');
...
add_shortcode("trx_br", "green_sc_br");
...
add_shortcode('trx_button', 'green_sc_button');
...
add_shortcode('trx_chat', 'green_sc_chat');
...
add_shortcode('trx_columns', 'green_sc_columns');
...
add_shortcode('trx_column_item', 'green_sc_column_item');
...
add_shortcode("trx_contact_form", "green_sc_contact_form");
...
function green_sc_contact_form($atts, $content = null) {
	...
	$output = '<div ' . ($id ? ' id="'.esc_attr($id).'"' : '') 
		...
		. ($content != '' && green_sc_param_is_on($custom)
			...
			: '<div class="sc_contact_form_info">'
					.'<div class="sc_contact_form_item sc_contact_form_field label_over"><input id="sc_contact_form_username" type="text" name="username" placeholder="' . esc_html__('First and last name*', 'green') . '"><input id="sc_contact_form_email" type="text" name="email" placeholder="' . esc_html__('Your Email *', 'green') . '"></div>'
					. '<div class="sc_contact_form_item sc_contact_form_field label_over"><input id="sc_contact_form_phone" type="text" name="phone" placeholder="' . esc_html__('Phone*', 'green') . '"><input id="sc_contact_form_subj" type="text" name="subject" placeholder="' . esc_html__('Subject', 'green') . '"></div>'
				.'</div>'
	...
	// 		.'<div class="sc_contact_form_item sc_contact_form_field label_over"><label class="required" for="sc_contact_form_subj">' . esc_html__('Subject', 'green') . '</label><input id="sc_contact_form_subj" type="text" name="subject" placeholder="' . esc_html__('Subject', 'green') . '"></div>'
	// 	.'</div>'
	...
	// 	.'<div class="sc_contact_form_item sc_contact_form_button"><button>'.esc_html__('SEND MESSAGE', 'green').'</button></div>'
	// )
}


add_shortcode('trx_form_item', 'green_sc_contact_form_item');
...
add_shortcode("trx_contact_form_slider", "green_sc_contact_form_slider");
...
add_shortcode('trx_form_item', 'green_sc_contact_form_slider_item');
...
add_shortcode('trx_content', 'green_sc_content');
...
add_shortcode("trx_countdown", "green_sc_countdown");
...
add_shortcode('trx_dropcaps', 'green_sc_dropcaps');
...
add_shortcode("trx_emailer", "green_sc_emailer");
...
function green_sc_emailer($atts, $content = null) {
	...
	$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '')
			...
			. '<input type="text" class="sc_emailer_input" name="email" value="" placeholder="'.esc_html__('Enter you email address.', 'green').'">'
...
add_shortcode("trx_gap", "green_sc_gap");
...
add_shortcode("trx_googlemap", "green_sc_google_map");
...
add_shortcode('trx_hide', 'green_sc_hide');
...
add_shortcode('trx_highlight', 'green_sc_highlight');
...
add_shortcode('trx_icon', 'green_sc_icon');
...
add_shortcode('trx_image', 'green_sc_image');
...
add_shortcode('trx_infobox', 'green_sc_infobox');
...
add_shortcode('trx_line', 'green_sc_line');
...
add_shortcode('trx_list', 'green_sc_list');
...
add_shortcode('trx_list_item', 'green_sc_list_item');
...
add_shortcode('trx_number', 'green_sc_number');
...
add_shortcode('trx_parallax', 'green_sc_parallax');
...
add_shortcode('trx_popup', 'green_sc_popup');
...
add_shortcode('trx_price', 'green_sc_price');

/*
[trx_price id="unique_id" currency="$" money="29.99" period="monthly"]

*/
function green_sc_price($atts, $content=null){	
	if (green_sc_in_shortcode_blogger()) return '';
    extract(green_sc_html_decode(shortcode_atts(array(
		// Individual params
		"money" => "",
	...
	return apply_filters('green_shortcode_output', $output, 'trx_price', $atts, $content);
}
...
add_shortcode('trx_price_block', 'green_sc_price_block');

/*
[trx_price id="unique_id" currency="$" money="29.99" period="monthly"]

*/
function green_sc_price_block($atts, $content=null){	
	if (green_sc_in_shortcode_blogger()) return '';
    extract(green_sc_html_decode(shortcode_atts(array(
		// Individual params
		"style" => 1,
	...
	$output = '<div' . ($id ? ' id="'.esc_attr($id).'"' : '') 
		...
		. '</div>';
	return apply_filters('green_shortcode_output', $output, 'trx_price_block', $atts, $content);
}
...
add_shortcode('trx_quote', 'green_sc_quote');
...
add_shortcode("trx_reviews", "green_sc_reviews");
...
add_shortcode('trx_search', 'green_sc_search');
...
add_shortcode('trx_section', 'green_sc_section');
add_shortcode('trx_block', 'green_sc_section');
...
add_shortcode('trx_skills', 'green_sc_skills');
...
add_shortcode('trx_skills_item', 'green_sc_skills_item');
...
add_shortcode('trx_slider', 'green_sc_slider');
...
add_shortcode('trx_slider_item', 'green_sc_slider_item');
...
add_shortcode('trx_socials', 'green_sc_socials');
...
add_shortcode('trx_social_item', 'green_sc_social_item');
...
add_shortcode('trx_table', 'green_sc_table');
...
add_shortcode("trx_tabs", "green_sc_tabs");
...
add_shortcode("trx_tab", "green_sc_tab");
...
add_shortcode('trx_team', 'green_sc_team');
...
add_shortcode('trx_team_item', 'green_sc_team_item');
...
add_shortcode('trx_testimonials', 'green_sc_testimonials');
...
add_shortcode('trx_testimonials_item', 'green_sc_testimonials_item');
...
add_shortcode('trx_title', 'green_sc_title');
...
add_shortcode('trx_toggles', 'green_sc_toggles');
...
add_shortcode('trx_toggles_item', 'green_sc_toggles_item');
...
add_shortcode('trx_tooltip', 'green_sc_tooltip');
...
add_shortcode('trx_twitter', 'green_sc_twitter');
...
add_shortcode("trx_video", "green_sc_video");
...
add_shortcode('trx_zoom', 'green_sc_zoom');
