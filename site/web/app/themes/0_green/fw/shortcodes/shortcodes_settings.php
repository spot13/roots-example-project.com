	...
	function green_shortcodes_settings_theme_setup() {
		if (green_shortcodes_is_used()) {
			...
			$GREEN_GLOBALS['shortcodes'] = array(
				...
				// Price
				"trx_price" => array(
					"title" => esc_html__("Price", "green"),
					"desc" => esc_html__("Insert price with decoration", "green"),
					"decorate" => false,
					"container" => false,
					"params" => array(
						"money" => array(
							"title" => esc_html__("Money", "green"),
							"desc" => esc_html__("Money value (dot or comma separated)", "green"),
							"value" => "",
							"type" => "text"
						),
						"currency" => array(
							"title" => esc_html__("Currency", "green"),
							"desc" => esc_html__("Currency character", "green"),
							"value" => "$",
							"type" => "text"
						),
						"period" => array(
							"title" => esc_html__("Period", "green"),
							"desc" => esc_html__("Period text (if need). For example: monthly, daily, etc.", "green"),
							"value" => "",
							"type" => "text"
						),
						"align" => array(
							"title" => esc_html__("Alignment", "green"),
							"desc" => esc_html__("Align price to left or right side", "green"),
							"value" => "",
							"type" => "checklist",
							"dir" => "horizontal",
							"options" => $GREEN_GLOBALS['sc_params']['float']
				...
				"trx_price_block" => array(
					"title" => esc_html__("Price block", "green"),
					"desc" => esc_html__("Insert price block with title, price and description", "green"),
					"decorate" => false,
					"container" => true,
					"params" => array(
						"title" => array(
							"title" => esc_html__("Title", "green"),
							"desc" => esc_html__("Block title", "green"),
							"value" => "",
							"type" => "text"
						),
						"link" => array(
							"title" => esc_html__("Link URL", "green"),
							"desc" => esc_html__("URL for link from button (at bottom of the block)", "green"),
							"value" => "",
							"type" => "text"
						),
						"link_text" => array(
							"title" => esc_html__("Link text", "green"),
							"desc" => esc_html__("Text (caption) for the link button (at bottom of the block). If empty - button not showed", "green"),
							"value" => "",
							"type" => "text"
						),
						"icon" => array(
							"title" => esc_html__("Icon",  'green'),
							"desc" => esc_html__('Select icon from Fontello icons set (placed before/instead price)',  'green'),
							"value" => "",
							"type" => "icons",
							"options" => $GREEN_GLOBALS['sc_params']['icons']
						),
						...
						"_content_" => array(
							"title" => esc_html__("Description", "green"),
							"desc" => esc_html__("Description for this price block", "green"),
							"divider" => true,
							"rows" => 4,
							"value" => "",
							"type" => "textarea"
