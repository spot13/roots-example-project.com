...
if ( !function_exists( 'green_exists_visual_composer' ) ) {
	function green_exists_visual_composer() {
		return class_exists('Vc_Manager');
	}
}

// Check if Visual Composer in frontend editor mode
if ( !function_exists( 'green_vc_is_frontend' ) ) {
	function green_vc_is_frontend() {
