...
// Shortcode template
if ( ! class_exists( 'GREEN_VC_ShortCode' ) ) {
	abstract class GREEN_VC_ShortCode extends WPBakeryShortCode {
...
if ( ! class_exists( 'GREEN_VC_ShortCodeSingle' ) ) {
	abstract class GREEN_VC_ShortCodeSingle extends GREEN_VC_ShortCode {
	}
}

// Single shortcode without params (woocommerce_cart, checkout, etc.)
if ( ! class_exists( 'GREEN_VC_ShortCodeAlone' ) ) {
	abstract class GREEN_VC_ShortCodeAlone extends GREEN_VC_ShortCode {
		protected $controls_list = array('clone', 'delete');
	}
}

// Container shortcode (block, section, parallax)
if ( ! class_exists( 'GREEN_VC_ShortCodeContainer' ) ) {
	abstract class GREEN_VC_ShortCodeContainer extends GREEN_VC_ShortCode {
...
if ( ! class_exists( 'GREEN_VC_ShortCodeCollection' ) ) {
	abstract class GREEN_VC_ShortCodeCollection extends GREEN_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'GREEN_VC_ShortCodeItem' ) ) {
	abstract class GREEN_VC_ShortCodeItem extends GREEN_VC_ShortCode {
...
if ( ! class_exists( 'GREEN_VC_ShortCodeColumns' ) ) {
	abstract class GREEN_VC_ShortCodeColumns extends GREEN_VC_ShortCodeContainer {
		protected $controls_css_settings = 'out-tc vc_controls-content-widget';
		protected $controls_list = array('add', 'edit', 'clone', 'delete');
	}
}
...
if ( ! class_exists( 'GREEN_VC_ShortCodeAccordion' ) ) {
	abstract class GREEN_VC_ShortCodeAccordion extends WPBakeryShortCode_VC_Accordion {}
	abstract class GREEN_VC_ShortCodeAccordionItem extends WPBakeryShortCode_VC_Accordion_tab {}
}
if ( ! class_exists( 'GREEN_VC_ShortCodeToggles' ) ) {
	abstract class GREEN_VC_ShortCodeToggles extends GREEN_VC_ShortCodeAccordion {}
	abstract class GREEN_VC_ShortCodeTogglesItem extends GREEN_VC_ShortCodeAccordionItem {}
}
...
if ( ! class_exists( 'GREEN_VC_ShortCodeTabs' ) ) {
	abstract class GREEN_VC_ShortCodeTabs extends WPBakeryShortCode_VC_Tabs {
		public function setCustomTabId( $content ) {
			return preg_replace( '/tab\_id\=\"([^\"]+)\"/', 'tab_id="sc_tab_$1_' . time() . '"', $content );
		}
	}
	abstract class GREEN_VC_ShortCodeTab extends WPBakeryShortCode_VC_Tab {
	}
}
