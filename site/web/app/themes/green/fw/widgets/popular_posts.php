 ...
 */
add_action( 'widgets_init', 'green_widget_popular_posts_load' );

/**
 * Register our widget.
 */
function green_widget_popular_posts_load() {
	register_widget('green_widget_popular_posts');
}

/**
 * Most popular and commented Widget class.
 */
class green_widget_popular_posts extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array('classname' => 'widget_popular_posts', 'description' => esc_html__('The most popular and most commented blog posts (extended)', 'green'));

		/* Widget control settings. */
		$control_ops = array('width' => 200, 'height' => 250, 'id_base' => 'green_widget_popular_posts');

		/* Create the widget. */
		parent::__construct( 'green_widget_popular_posts', esc_html__('ThemeREX - Most Popular & Commented Posts', 'green'), $widget_ops, $control_ops );
	}
	...
	function widget($args, $instance) {
		...
		$show_counters = isset($instance['show_counters']) && $instance['show_counters'] > 0 ? green_get_theme_option('blog_counters') : '';
	...
	function form($instance) {
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_popular')); ?>"><?php esc_html_e('Most popular tab title:', 'green'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_commented')); ?>"><?php esc_html_e('Most commented tab title:', 'green'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id('title_liked')); ?>"><?php esc_html_e('Most liked tab title:', 'green'); ?></label>
		...
		<p>
			...
			<label for="<?php echo esc_attr($this->get_field_id('show_counters')); ?>_1"><?php esc_html_e('Show', 'green'); ?></label>
