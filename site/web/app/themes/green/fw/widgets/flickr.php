 ...
 */
add_action( 'widgets_init', 'green_widget_flickr_load' );

/**
 * Register our widget.
 */
function green_widget_flickr_load() {
	register_widget( 'green_widget_flickr' );
}

/**
 * flickr Widget class.
 */
class green_widget_flickr extends WP_Widget {
	...
	function __construct() {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'widget_flickr', 'description' => esc_html__('Last flickr photos.', 'green') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 200, 'height' => 250, 'id_base' => 'green_widget_flickr' );

		/* Create the widget. */
		parent::__construct( 'green_widget_flickr', esc_html__('ThemeREX - Flickr photos', 'green'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'count' => 6, 'description' => esc_html__('Last flickr photos', 'green') );
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_username' )); ?>"><?php esc_html_e('Flickr ID (<a href="http://www.idgettr.com" target="_blank">idGettr</a>):', 'green'); ?></label>
		...
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'flickr_count' )); ?>"><?php esc_html_e('Number of photos:', 'green'); ?></label>
